...
<form action="{{ route('user.cart.cart.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <br>
    <button type="submit" name="submit" class="proceed-order">SAVE AND DELIVER HERE</button>
    <button><a href="{{ route('user.cart.cart') }}">CANCEL</a></button>
</form>
