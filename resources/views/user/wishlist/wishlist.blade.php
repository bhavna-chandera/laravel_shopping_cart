...
<form action="{{ route('user.wishlist.wishlist') }}" method="get" class="search-form">

    <input type="text" name="search" class="search" placeholder="search anything">
    <select name="filterbycat" class="filterbycat">
        <option value="">Select Category</option>
        <option value=2>1.Electronics</option>
        <option value=3>2.Beauty and personal care</option>
        <option value=4>3.Health and Wellness</option>
        <option value=5>4.Fashion</option>
        <option value=6>5.Household and Grocery</option>
        <option value=7>6.Other</option>
    </select>
...
<div class="products_container">
    ...
    <div class="card">
        ...
        <div class='info'>
            ...
            $totalRating = round($product->ratings_count ?? 0, 2);
...
@else
<div class="warnbox">
    <h2>Empty Wishlistt </h2>
    <p>please click here to
        <a href="{{ route('user.products.products') }}" class="addprodlink">add products here</a>
    </p>
</div>
@endif
